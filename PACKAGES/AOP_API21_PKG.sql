--------------------------------------------------------
--  DDL for Package AOP_API21_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "INSTITUTE"."AOP_API21_PKG" 
AUTHID CURRENT_USER
as
...
c_aop_version               constant varchar2(6)  := '21.1.2';                               
--### AOP URLs
...
--### JSON
g_anonymize_json            varchar2(1)   := c_n;   -- set to Y (c_y) if you want to anomyze the JSON that is send over. This is great for debugging of sensitive data.
