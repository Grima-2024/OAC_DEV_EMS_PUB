--------------------------------------------------------
--  DDL for Package Body AS_PDF3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "INSTITUTE"."AS_PDF3" as_pdf3
is
--
...
--
    /*procedure download(p_pdf_doc blob, p_filename varchar2)
    as
        l_pdf_doc blob;
    BEGIN
        p_pdf_doc := l_pdf_doc;
...
--
  ...
  begin
    ...
    --t_fh := utl_file.fopen(p_filename, 'wb' );
