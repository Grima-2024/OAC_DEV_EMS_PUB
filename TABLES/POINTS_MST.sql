--------------------------------------------------------
--  DDL for Table POINTS_MST
--------------------------------------------------------

  CREATE TABLE "INSTITUTE"."POINTS_MST" 
   (	"POINT_ID" NUMBER, 
	"POINT_NAME" VARCHAR2(500 BYTE) COLLATE "USING_NLS_COMP", 
	"POINT_CODE" VARCHAR2(20 BYTE) COLLATE "USING_NLS_COMP", 
	"ROUTE_ID" NUMBER, 
	"INSTITUTE_ID" NUMBER, 
